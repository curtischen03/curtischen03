...
💻 I specialize in building responsive, high-performance web applications using **React** and **Next.js**. Currently, I'm:
* 🚀 Integrating microservices and translating Figma designs into code at **Koios Enterprises**.
* 🏊‍♂️ Engineering PostgreSQL-backed athletic dashboards for **UC Berkeley Athletics**.
